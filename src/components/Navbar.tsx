      ...
      <div className="content w-11/12 lg:w-4/5 mx-auto flex items-center justify-between">
        ...
        <div className="navigation flex items-center space-x-3">
          ...
          <div className="auth-btns max-lg:hidden space-x-3">
            <Link href="#" className="bg-primary-400 text-white py-2 px-3 hover:bg-primary-600 hover:duration-200">Se connecter</Link>
            <Link href="#" className="bg-primary-400 text-white py-2 px-3 hover:bg-primary-600 hover:duration-200">S&apos;enregistrer</Link>
          </div>
